...
public class Mission {
   ...
   */
  public void executeCmd(Integer id,Rover.Command cmd){

    Rover rover = rovers.get(id);

    if(rover == null){
      throw new IllegalArgumentException("Rover not found");
    }
  ...
  /**
   *  Retrieves info for a rover
   */
  public RoverInfo getRoverInfo(Integer id){
    ...
    RoverInfo info = new RoverInfo(id,rover);
    return info;
  }
